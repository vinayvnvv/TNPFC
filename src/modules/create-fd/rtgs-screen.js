...
const RTGSScreen = ({
    ...
    <body>
        ...
        <div class="header-s">
            ...
            <div class="welce">
                ${new Date().toDateString()} and ${new Date().toTimeString()}<br/>
                Dear <b>${depositorName || 'Name'}</b>,<br/>
                ...
                <tbody>
                   ...
                   <tr>
                    ...
                    <tr>
                        ...
                        <td>${nameofBeneficiaryAccount}</td>
                    </tr>
                    <tr>
